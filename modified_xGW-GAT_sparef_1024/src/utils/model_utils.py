...
from src.models.SpaRef import SpaRef
...
def build_model(args, num_features, ood_dataset=None):
    ...
    elif args.model_name == "sparef_gcn" and args.sparse_method == "vae":
        model = SpaRef(
            GCN(num_features, args),
            MLP(
                args.num_classes,
    ...
    elif args.model_name == "sparef_gcn" and args.sparse_method == "mae":
        model = SpaRef(
            GCN(num_features, args),
            MLP(
                args.num_classes,
