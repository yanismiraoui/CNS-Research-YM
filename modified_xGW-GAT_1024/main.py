...
class xGW_GAT:
    def main(self):
        ...
        parser.add_argument(
            "--model_name", type=str, default="sparef_gcn", choices=["fc", "gcn", "gatv2", "sparef_gcn"]
        )
        parser.add_argument(
        ...
        parser.add_argument("--weights_lambda", type=int, default=1)
        ...
        val_loader = DataLoader(
                    val_dataset, batch_size=args.test_batch_size, shuffle=False, drop_last=True
                )
                                ...
                                for weights_elastic in weights_elastic_values:
                                    ...
                                    for train_idx, test_idx in KFold(
                                        ...
                                        for k in args.k_list:
                                            ...
                                            model = build_model(args, train_test_dataset.num_features, test_scanner_loader)
                                            ...
                                            train_acc, train_auc, train_loss, test_acc, test_auc, test_loss, train_model = train_eval(
                                                ...
                                                ood_dataset=test_scanner_loader,
                                            )
                                    ...
                                    save_result_tuning[(MLP_layers, GNN_layers, num_heads, hidden_dim, dropout, loss_lambda, weights_lambda, weights_elastic)].append(f"Similarity between masks: {similarity_masks}")
